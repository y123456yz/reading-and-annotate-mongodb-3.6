...
//ServiceContextMongoD::initializeGlobalStorageEngine()中根据不同配置选择不同storageEngine

//ServiceContextMongoD._storageEngine成员类型为该类型，
//KVStorageEngine MMAPV1Engine 例如WT则在WiredTigerFactory::create中new该类 
class StorageEngine {
public:
    /**
    ...
    //KVStorageEngine::reconcileCatalogAndIdents中使用
