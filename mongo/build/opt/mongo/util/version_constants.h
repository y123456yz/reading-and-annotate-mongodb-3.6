...
const std::initializer_list<VersionInfoInterface::BuildInfoTuple> kBuildEnvironment =
    { std::make_tuple("distmod", "", true, true), std::make_tuple("distarch", "x86_64", true, true), std::make_tuple("cc", "gcc: gcc (GCC) 5.4.0", true, false), std::make_tuple("ccflags", "-fno-omit-frame-pointer -fno-strict-aliasing -ggdb -pthread -static-libstdc++ -Wall -Wsign-compare -Wno-unknown-pragmas -Winvalid-pch -Werror -O2 -Wno-unused-local-typedefs -Wno-unused-function -Wno-deprecated-declarations -Wno-unused-but-set-variable -Wno-missing-braces -fstack-protector-strong -fno-builtin-memcmp", true, false), std::make_tuple("cxx", "g++: g++ (GCC) 5.4.0", true, false), std::make_tuple("cxxflags", "-Woverloaded-virtual -Wno-maybe-uninitialized -std=c++14", true, false), std::make_tuple("linkflags", "-pthread -Wl,-z,now -rdynamic -Wl,--fatal-warnings -fstack-protector-strong -fuse-ld=gold -Wl,--build-id -Wl,--hash-style=gnu -Wl,-z,noexecstack -Wl,--warn-execstack -Wl,-z,relro", true, false), std::make_tuple("target_arch", "x86_64", true, true), std::make_tuple("target_os", "linux", true, false) };
